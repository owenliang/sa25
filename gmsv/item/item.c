...
BOOL ITEM_initExistItemsArray( int num )
{
	...
	print("�ڶ��η��� %4.2f MB �ռ�...", sizeof( ITEM_exists ) * num /1024.0/1024.0);
	return TRUE;
}
...
#define ITEM_ID_TOKEN_INDEX 15
	...
	print("ITEM_tbl���� %4.2f MB �ռ�...", sizeof(ITEM_table) * ITEM_tblen /1024.0/1024.0);
	print("ITEM_idx���� %4.2f MB �ռ�...", sizeof(ITEM_index) * ITEM_idxlen /1024.0/1024.0);
